...
//its were all our zombies will be stored for each round
...
void displayCurrentStatsAndThings(Map mainGameMap, Player currentPlayer, int turns){
    cout << endl;
    //mainGameMap.displayMap();

    cout << endl;

    cout << "Player: " << currentPlayer.getPlayerName() << "      ";
    cout << "Turn Number: " << turns << endl;

    cout << "Health: " << currentPlayer.getPlayerHealth() << "      ";
    cout << "Stamina: " << currentPlayer.getPlayerStamina() << endl;

    cout << "Inventory Size: " << currentPlayer.getPlayerInventorySize() << "      ";
...
bool play(){
    ...
    vector<Zombie> zombiesVec = createZombiesVec(15);
...
int main(){
    ...
    cout << "they arent playing anymore" << endl;
